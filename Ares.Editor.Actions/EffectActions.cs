...
namespace Ares.Editor.Actions
{
    ...
    {
        public CueEffectChangeAction(IList<IEffectsElement> elements,
        ...
        protected abstract ICueEffect getEffect(IEffectsElement element);
        ...
        protected IList<IEffectsElement> m_Elements;
    ...
    {
        public CueInEffectChangeAction(IList<IEffectsElement> elements,
            bool active, double position)
            : base(elements, active, position)
        {
        }

        protected override ICueEffect getEffect(IEffectsElement element)
        {
    ...
    {
        public CueOutEffectChangeAction(IList<IEffectsElement> elements,
            bool active, double position)
            : base(elements, active, position)
        {
        }
